...
**提交 issue 之前，确保您已经了解这些概念，**所以，请阅读以下内容，如果有任何反馈，请告知我们。
...
如果您已经准备好，可以跳转到 [#我如何配置来使用typescript-eslint](#how-do-i-configure-my-project-to-use-typescript-eslint)
<br>

## 什么是ESLint、TypeScript？它们有何关系?

**ESLint** 是极好的 JavaScript 代码检查器。
...
- 它的主要原理是：使用 parser 将您的源代码转换成称为抽象语法树（AST）的数据结构。然后 lint 规则通过 AST 来检查代码是否符合规则。
